...
- I've already deployed the backend so you can just try out the extension yourself by simply upload **extension file** to **chrome://extensions/** and enable developer mode, or:
